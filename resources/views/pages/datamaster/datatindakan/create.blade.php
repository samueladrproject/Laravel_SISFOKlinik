            ...
            <div class="col-lg">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
                        <h6 class="m-0 font-weight-bold text-white">Tambah Data Tindakan</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <form action="{{ URL::to('data-tindakan') }}" method="post">
                            @csrf
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control  @error('kodetindakan') is-invalid @enderror"
                                        id="kodetindakan" name="kodetindakan" value="{{ $newkodetindakan }}" readonly>
                                    @error('kodetindakan')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control  @error('namatindakan') is-invalid @enderror"
                                        id="namatindakan" name="namatindakan" value="{{ old('namatindakan') }}" autofocus>
                                    @error('namatindakan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="input-group col-sm-9">
                                    ...
                                    <input type="text" class="form-control @error('hargalayanan') is-invalid @enderror"
                                        ...
                                        id="hargalayanan" value="{{ old('hargalayanan') }}">
                                    @error('hargalayanan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
