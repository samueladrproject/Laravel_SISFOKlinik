            ...
            <div class="col-lg">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
                        <h6 class="m-0 font-weight-bold text-white">Tambah Data Obat</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <form action="{{ URL::to('data-obat') }}" method="post">
                            @csrf
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control  @error('namaobat') is-invalid @enderror"
                                        id="namaobat" name="namaobat" value="{{ old('namaobat') }}" autofocus>
                                    @error('namaobat')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control @error('stokobat') is-invalid @enderror"
                                        id="stokobat" name="stokobat" value="{{ old('stokobat') }}">
                                    @error('stokobat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
