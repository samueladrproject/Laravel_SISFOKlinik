            ...
            <div class="col-lg">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
                        <h6 class="m-0 font-weight-bold text-white">Tambah Data Wilayah</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <form action="{{ URL::to('data-wilayah') }}" method="post">
                            @csrf
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control  @error('namaprovinsi') is-invalid @enderror"
                                        id="namaprovinsi" name="namaprovinsi" value="{{ old('namaprovinsi') }}" autofocus>
                                    @error('namaprovinsi')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        class="form-control  @error('namakabupatenkota') is-invalid @enderror" id="namaobat"
                                        name="namakabupatenkota" value="{{ old('namakabupatenkota') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control  @error('namakecamatan') is-invalid @enderror"
                                        id="namakecamatan" name="namakecamatan" value="{{ old('namakecamatan') }}">
                                    @error('namakecamatan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control  @error('namakelurahan') is-invalid @enderror"
                                        id="namakelurahan" name="namakelurahan" value="{{ old('namakelurahan') }}">
                                    @error('namakelurahan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
