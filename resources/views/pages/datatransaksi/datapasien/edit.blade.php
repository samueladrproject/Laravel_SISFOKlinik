        ...
        <div class="row">
            <div class="col-lg">
                <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <form action="{{ URL::to('data-pasien/' . $dataPasien->id_pasien) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="kodepasien" name="kodepasien"
                                        value="{{ $dataPasien->kode_pasien }}" readonly>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control  @error('namapasien') is-invalid @enderror"
                                        ...
                                        value="{{ old('namapasien') ? old('namapasien') : $dataPasien->nama_pasien }}">
                                    @error('namapasien')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control @error('alamatpasien') is-invalid @enderror"
                                        ...
                                        rows="3">{{ old('alamatpasien') ? old('alamatpasien') : $dataPasien->alamat_pasien }}</textarea>
                                    @error('alamatpasien')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control  @error('tanggallahir') is-invalid @enderror"
                                        ...
                                        value="{{ old('tanggallahir') ? old('tanggallahir') : $dataPasien->tanggal_lahir }}">
                                    @error('tanggallahir')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select @error('jeniskelamin') is-invalid @enderror"
                                        ...
                                        @else
                                            <option disabled>Pilih salah satu...</option>
                                            <option value="Laki - Laki"
                                                {{ $dataPasien->jenis_kelamin == 'Laki - Laki' ? 'selected' : '' }}>Laki
                                                - Laki
                                            </option>
                                            <option value="Perempuan"
                                                {{ $dataPasien->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        @endif
                                    </select>
                                    @error('jeniskelamin')
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                                        ...
                                        @else
                                            ...
                                            <option value="Single"
                                                {{ $dataPasien->status == 'Single' ? 'selected' : '' }}>
                                                Single</option>
                                            <option value="Menikah"
                                                {{ $dataPasien->status == 'Menikah' ? 'selected' : '' }}>
                                                Menikah</option>
                                            <option value="Duda" {{ $dataPasien->status == 'Duda' ? 'selected' : '' }}>
                                                Duda
                                            </option>
                                            <option value="Janda" {{ $dataPasien->status == 'Janda' ? 'selected' : '' }}>
                                                Janda
                                            </option>
                                        @endif
                                    </select>
